...
const data = [
  { date: "Nov 6, 2023", time: "2:30-4:00 pm" },
  { date: "Nov 17, 2023", time: "9:30-11:00 am" },
  { date: "Nov 20, 2023", time: "1:00-2:30 pm" },
];

export default function RescheduleCalendar({ route }) {
  ...
  const handlePress = (date, time) => {
    dispatch({
      ...
      payload: { id, updatedFields: { date, time, doctor } },
    });
    navigation.navigate('RescheduleConfirm', { date, time, doctor });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.midText}> New Suggested Appointment Times</Text>
